...
class Attribute15:
    ...
    def __init__(self):
        ...
        self.svc = pickle.load(open('svc_15.pkl', 'rb'))
        self.tfidf_2 = pickle.load(open('tfidf_15_2.pkl', 'rb'))
    ...
    def predict(self, df, further_precision=True):
        ...
        ada_model = pickle.load(open('ada_15_model.pkl', 'rb'))
        svc = pickle.load(open('svc_15.pkl', 'rb'))
        tfidf_2 = pickle.load(open('tfidf_15_2.pkl', 'rb'))
